...
ActiveRecord::Schema.define(version: 2019_08_03_150601) do
  ...
  create_table "pousse_publications", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "publications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "major_publication"
    t.boolean "visible"
    t.index ["pouss_type", "pouss_id"], name: "index_publications_on_pouss_type_and_pouss_id"
